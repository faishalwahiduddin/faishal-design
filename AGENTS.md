...
- **Validasi (§VAL)**: Di setiap project tanpa kecuali, setiap input, form, dan mutation wajib divalidasi di frontend dan backend — lihat [`docs/standards.md` §VAL](../../docs/standards.md#val--validasi-wajib-frontend-dan-backend-di-setiap-input-form-dan-mutation).
