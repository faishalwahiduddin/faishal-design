...
void main() {
  testWidgets('ThemeSwitcher toggles between light and dark mode', (WidgetTester tester) async {
    ...
    expect(prefs.getString('faishal_design_theme_mode'), ThemeMode.dark.toString());
    ...
    expect(find.byIcon(Icons.light_mode), findsOneWidget);
    expect(prefs.getString('faishal_design_theme_mode'), ThemeMode.light.toString());
  });

  testWidgets('ThemeSwitcher loads persisted theme mode', (WidgetTester tester) async {
    SharedPreferences.setMockInitialValues({
