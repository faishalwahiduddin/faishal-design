...
void main() {
  ...
  group('SparklineChart Widget', () {
    testWidgets('renders CustomPaint with data', (WidgetTester tester) async {
      ...
      expect(find.descendant(of: find.byType(SparklineChart), matching: find.byType(CustomPaint)), findsWidgets);
    ...
    testWidgets('renders No Data with empty list', (WidgetTester tester) async {
      ...
      expect(find.descendant(of: find.byType(SparklineChart), matching: find.byType(CustomPaint)), findsNothing);
